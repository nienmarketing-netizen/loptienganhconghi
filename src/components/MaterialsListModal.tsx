      ...
      >
          ...
          <div className="space-y-2.5">
            ...
            {materials.map((mat) => {
              ...
              return (
                <div
                  key={mat.id}
                  className="p-3.5 rounded-lg sm:rounded-xl border border-white/90 border-b-[#babecc] border-r-[#babecc] bg-[#e0e5ec] shadow-[var(--shadow-card-sm)] flex items-center justify-between gap-3"
                >
                  <button
                    type="button"
                  ...
                  >
                    <div
                      className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 bg-[#d1d9e6] border border-[#babecc]/60 shadow-[var(--shadow-recessed-sm)] text-[#ff4757]"
                    >
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <button
                      type="button"
                      onClick={() => onSelectMaterial(mat.id)}
                      className="px-3 py-1.5 rounded-lg bg-[#e0e5ec] hover:bg-[#d8e0ec] text-[#1a1a1a] text-xs font-semibold transition-all cursor-pointer border border-white/90 shadow-[var(--shadow-card-sm)] active:translate-y-[1px] flex items-center gap-1 leading-tight"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg text-[#666666] hover:text-[#ff4757] bg-[#e0e5ec] border border-white/90 shadow-[var(--shadow-card-sm)] active:translate-y-[1px] transition-colors cursor-pointer"
                      title="Tải về máy"
                    >
        ...
        <div className="p-4 sm:p-5 bg-[#e0e5ec] border-t border-[#babecc]/50 flex items-center justify-between gap-3">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2.5 rounded-lg text-[#1a1a1a] bg-[#e0e5ec] border border-white/90 shadow-[var(--shadow-card-sm)] hover:bg-[#d8e0ec] font-semibold text-xs sm:text-sm transition-all active:translate-y-[1px] cursor-pointer leading-tight"
          >
            Đóng
          </button>
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-lg bg-[#ff4757] hover:bg-[#ff3344] text-white font-semibold text-xs sm:text-sm shadow-[var(--shadow-accent)] flex items-center gap-2 transition-all cursor-pointer active:translate-y-[1px] border border-white/30 leading-tight"
          >
