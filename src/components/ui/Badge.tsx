...
export function Badge({ className, variant = "default", children, id, ...props }: BadgeProps) {
  ...
  return (
    <span
      id={id}
      className={cn(
        "inline-flex items-center gap-1.5 rounded-md border px-2.5 py-0.5 text-xs font-semibold tracking-normal whitespace-nowrap transition-colors select-none",
